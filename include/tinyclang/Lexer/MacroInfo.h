#ifndef TINYCLANG_LEXER_MACROINFO_H
#define TINYCLANG_LEXER_MACROINFO_H
...
#endif
 public:
  MacroInfo(SourceLocation DefLoc) : Location(DefLoc) { isDisabled = false; }
...
#endif  // TINYCLANG_LEXER_MACROINFO_H